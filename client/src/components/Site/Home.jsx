    ...
    return (
        <div className="homeContainer">
            ...
            <h3>Look at all the banners!</h3>
            {
                user.id ? (
                    <>
                    <h3> Glad you're back, {user.firstname}!</h3>
                    ...
                    <Link to="/books" className="registerNowLink">Log in</Link> to reserve books!<br/>Not a member? 
                    <Link to="/register" className="registerNowLink">Register now</Link>!</h4>
                )
            }
        </div>
    )
